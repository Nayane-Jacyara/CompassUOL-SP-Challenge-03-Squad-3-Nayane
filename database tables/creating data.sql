...
-- Ininserting users
INSERT INTO tb_user (firstName, lastName, email, password, roles) VALUES ('John', 'Doe', 'john@gmail.com', 'john', 'ROLE_USER');
INSERT INTO tb_user (firstName, lastName, email, password, roles) VALUES ('Jane', 'Smith', 'jane@gmail.com', 'jane', 'ROLE_USER');
INSERT INTO tb_user (firstName, lastName, email, password, roles) VALUES ('Nayane', 'Jacyara', 'njcs@discente.ifpe.edu.br
', 'admin123', 'ROLE_ADMIN');
...
INSERT INTO tb_user_role (user_id, role_id) VALUES (3, 2); -- Admin é atribuído a ROLE_ADMIN
